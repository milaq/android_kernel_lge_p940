...
u8 u760_hitachi_lcd_command_for_mipi[][60] = {                                                                                       
	{LONG_CMD_MIPI, DSI_GEN_LONGWRITE, 0x04, 0xb9, 0xff, 0x83, 0x89,},
	{LONG_CMD_MIPI, DSI_GEN_LONGWRITE, 0x03, 0xba, 0x01, 0x92,},
	{LONG_CMD_MIPI, DSI_GEN_LONGWRITE, 0x03, 0xde, 0x05, 0x58,},
	{LONG_CMD_MIPI, DSI_GEN_LONGWRITE, 0x14, 0xb1, 0x00, 0x00, 0x04, 0xe3, 0x50, 0x10, 0x11, 0xb2, 0x11, 0x2b, 0x33,
	 0x25, 0x25, 0x41, 0x00, 0x3a, 0xf7, 0x01, 0x00,},
	{LONG_CMD_MIPI, DSI_GEN_LONGWRITE, 0x06, 0xb2, 0x00, 0x00, 0x78, 0x03, 0x02,},
	{LONG_CMD_MIPI, DSI_GEN_LONGWRITE, 0x18, 0xb4, 0x00, 0x04, 0x00, 0x32, 0x10, 0x00, 0x32, 0x10, 0x00, 0x00, 0x00,
	 0x00, 0x17, 0x00, 0xa0, 0x02, 0x13, 0x00, 0xa0, 0x00, 0xff, 0x96, 0x14,},
	{LONG_CMD_MIPI, DSI_GEN_LONGWRITE, 0x31, 0xd5, 0x00, 0x00, 0x4c, 0x00, 0x01, 0x00, 0x00, 0x00, 0x20, 0x00, 0x99,
	...
	{LONG_CMD_MIPI, DSI_GEN_LONGWRITE, 0x23, 0xe0, 0x00, 0x24, 0x25, 0x3f, 0x3c, 0x3e, 0x29, 0x4c, 0x03, 0x0b, 0x0c,
	 0x11, 0x13, 0x11, 0x13, 0x13, 0x1c, 0x00, 0x24, 0x25, 0x3f, 0x3c, 0x3e, 0x29,
	 0x4c, 0x03, 0x0b, 0x0c, 0x11, 0x13, 0x11, 0x13, 0x13, 0x1c,},
	{LONG_CMD_MIPI, DSI_GEN_LONGWRITE, 0x06, 0xb6, 0x00, 0x00, 0x00, 0x89, 0xe0,},
	{SHORT_CMD_MIPI, DSI_GEN_SHORTWRITE_2PARAM, 0x02, 0xcc, 0x0e},
	{LONG_CMD_MIPI, DSI_GEN_LONGWRITE, 0x03, 0xcb, 0x07, 0x07,},
	{LONG_CMD_MIPI, DSI_GEN_LONGWRITE, 0x05, 0xbb, 0x00, 0x00, 0xff, 0x80,},
...
static ssize_t display_porch_value_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	struct omap_dss_device *dssdev = to_dss_device(dev);
...
static ssize_t display_porch_value_store(struct device *dev,
		struct device_attribute *attr,
...
// patch from sangjae.han
	...
	if(dssdev->phy.dsi.type == OMAP_DSS_DSI_TYPE_VIDEO_MODE){
			...
			td->display_on = false;
		mdelay(10);
		//hx8389_panel_dcs_write_1(td, 0xcc, 0x06);
		if(dssdev->phy.dsi.type == OMAP_DSS_DSI_TYPE_CMD_MODE){
			r = _hx8389_panel_enable_te(dssdev, false);
			if (r)
				goto err;
